...
endpoint: GET - https://371ea2ur16.execute-api.ap-south-1.amazonaws.com/dev/items

for extension enabling go to: https://supabase.com/dashboard/project/olsuhufpdhrjxiobqvxm/database/extensions
and search pg_trgm and enable/disbale there and select schema public
